...
const STREAMS_LOCATION = process.env.STREAMS_LOCATION || path.join(__dirname, "./../streams");
const DELIMITER = "||";
...
class Coinstream extends EventEmitter {
    ...
    constructor(opts = {}){
        ...
        this.step = step || 20;
        this.streamDir = streamDir || STREAMS_LOCATION;
    ...
    startStream(){
        ...
        this._storeInverval = setInterval(() => {
    ...
    close(){
        ...
        if(this._storeInverval){
            clearInterval(this._storeInverval);
        }
    }
}
