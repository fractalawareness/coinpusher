...
class SocketServer extends EventEmitter {
    ...
    constructor(config = null, coinpusher = null){
        ...
        this.config = config || { port: SERVER_PORT };
        this.wss = null;
        this._kickInactiveSocketsInterval = null;
        this.server = null;
    }
    ...
    start(){
        return new Promise(resolve => {
            ...
            this._kickInactiveSocketsInterval = setInterval(() => {
    ...
    close(){
        ...
        if(this._kickInactiveSocketsInterval){
            clearInterval(this._kickInactiveSocketsInterval);
        }
