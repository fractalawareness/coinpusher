...
const BTC_PORT = process.env.BTC_PORT || 3333;
const ETH_PORT = process.env.ETH_PORT || 3334;
const LTC_PORT = process.env.LTC_PORT || 3335;
...
class Coinpusher extends EventEmitter {
    ...
    startForBitcoin(){
        return this.start(CURRENCY.BTC_EUR, BTC_PORT);
    }

    startForEthereum(){
        return this.start(CURRENCY.ETH_EUR, ETH_PORT);
    }

    startForLitecoin(){
        return this.start(CURRENCY.LTC_EUR, LTC_PORT);
    }
